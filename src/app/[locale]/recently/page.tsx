...
export default async function RecentlyPage(props: {
  ...
  return (
    <div className="max-w-screen-2xl mx-auto">
      ...
      <div className="max-w-4xl mx-auto px-6 md:px-0 space-y-10 md:space-y-16">
        {posts.map((post) => (
          <article key={post._id} className="group relative border-b border-brand-charcoal/5 pb-10 md:pb-16 last:border-0">
            <Link href={`/recently/${post.slug?.current || '#'}`} className="block">
              <div className="flex flex-col md:flex-row md:items-start gap-6 md:gap-8">
                ...
                <div className="grow space-y-3 md:space-y-4">
                  ...
                  <div className="text-[10px] uppercase tracking-[0.2em] opacity-50 group-hover:opacity-100 transition-opacity flex items-center gap-2 pt-2 md:pt-3">
