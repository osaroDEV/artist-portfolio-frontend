    ...
    <html lang={locale} suppressHydrationWarning>
      ...
      >
        <NextIntlClientProvider messages={messages}>
          <Navigation />
          <main className="min-h-screen pt-32 md:pt-24 md:ml-64 px-6 md:px-16 max-w-screen-2xl pb-24">
            {children}
          </main>

          {/* Subtle footer */}
          <footer className="px-6 md:px-12 py-16 mt-12 max-w-screen-2xl mx-auto flex flex-col space-y-12 transition-all">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-12 md:gap-0">
               <div className="flex flex-col space-y-2 opacity-70 text-[10px] uppercase tracking-widest"> 
               ...
               <div className="flex flex-col md:flex-row gap-12 md:gap-16 items-start md:items-center">
                 ...
                 <div className="flex space-x-6 text-[10px] uppercase tracking-widest text-brand-charcoal">
                   <a href={settings?.instagramUrl || "https://www.instagram.com/ellarbecker"} target="_blank" rel="noopener noreferrer" className="opacity-70 hover:opacity-100 transition-opacity">
                   ...
                   <FooterLegal content={settings?.impressum} title={locale === 'de' ? 'Impressum' : 'Imprint'} locale={locale} />
                 </div>
               </div>
            </div>
          </footer>
