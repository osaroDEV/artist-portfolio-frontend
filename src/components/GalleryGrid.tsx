    ...
    <>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-12 lg:gap-16">
        {items.map((item, index) => (
          <div key={item._id} onClick={() => setSelectedIndex(index)} className="cursor-pointer">
          ...
          >
            ...
            <div className="absolute inset-x-0 top-1/2 -translate-y-1/2 hidden md:flex justify-between px-8 z-20 pointer-events-none">
              <button
                ...
                className="pointer-events-auto p-4 text-white/40 hover:text-white transition-all hover:scale-110"
            ...
            >
              ...
              <div className="md:hidden flex justify-center space-x-12 py-2">
                <button onClick={goToPrevious} className="text-white/60 p-2"><ChevronLeft size={32} /></button>
                <button onClick={goToNext} className="text-white/60 p-2"><ChevronRight size={32} /></button>
              </div>

              {/* Caption Bar */}
              <div className="bg-black/40 backdrop-blur-sm p-4 md:p-6 flex justify-between items-center text-white">
                ...
                <div className="hidden md:flex items-center space-x-4">
                   <button onClick={goToPrevious} className="hover:text-white text-white/40 transition-colors"><ChevronLeft size={20} /></button>
                   <button onClick={goToNext} className="hover:text-white text-white/40 transition-colors"><ChevronRight size={20} /></button>
                </div>
              </div>
            </motion.div>
          </motion.div>
